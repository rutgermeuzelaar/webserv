...
LocationContext.cpp Parser.cpp Port.cpp Scanner.cpp ServerContext.cpp HTTPStatusCode.cpp \
main.cpp Request.cpp HTTPStatusLine.cpp Response.cpp socket.cpp Utilities.cpp
NAME := webserv
